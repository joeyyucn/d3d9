...
namespace D3D
{
	...
	const D3DCOLOR	GRAY = D3DCOLOR_XRGB(100, 100, 100);
	...
	const D3DXCOLOR XGRAY = D3DXCOLOR(GRAY);
	...
	const D3DMATERIAL9 GRAYMATERIAL = InitMaterial(XGRAY, XGRAY, XGRAY, XBLACK, 8.0f);
